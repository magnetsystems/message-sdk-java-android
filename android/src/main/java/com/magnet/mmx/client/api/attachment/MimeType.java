...
public final class MimeType {
  ...
  public static final MimeType IMAGE = MimeType.parse("image");
  ...
  private MimeType(String mediaType, String type, String subtype, String charset) {
  ...
  public static MimeType parse(String string) {
    ...
    return new MimeType(string, type, subtype, charset);
  }
  ...
  @Override public boolean equals(Object o) {
    return o instanceof MimeType && ((MimeType) o).mediaType.equals(mediaType);
  }

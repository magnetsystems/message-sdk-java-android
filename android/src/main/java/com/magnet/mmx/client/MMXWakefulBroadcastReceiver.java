 ...
 * <h3>Example</h3>
 *
 * <p>A {@link MMXWakefulBroadcastReceiver} uses the method
 * {@link MMXWakefulBroadcastReceiver#startWakefulService startWakefulService()}
 ...
 * the {@link MMXWakefulBroadcastReceiver} is holding a wake lock when the service
 ...
 * {@link MMXWakefulBroadcastReceiver#completeWakefulIntent
 * completeWakefulIntent(intent)}. The intent it passes as a parameter
 * is the same intent that the {@link MMXWakefulBroadcastReceiver} originally
 * passed in.</p>
 *
 * {@sample development/samples/Support4Demos/src/com/example/android/supportv4/content/SimpleWakefulService.java complete}
 */
public abstract class MMXWakefulBroadcastReceiver extends BroadcastReceiver {
